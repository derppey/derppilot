...
#include "selfdrive/ui/chubbs/qt/network/networking.h"

#include "selfdrive/ui/chubbs/qt/offroad/settings/device_panel.h"
#include "selfdrive/ui/chubbs/qt/offroad/settings/software_panel.h"
#include "selfdrive/ui/chubbs/qt/offroad/settings/sunnylink_panel.h"
#include "selfdrive/ui/chubbs/qt/offroad/settings/chubbs_panel.h"
#include "selfdrive/ui/chubbs/qt/offroad/settings/trips_panel.h"
...
SettingsWindowSP::SettingsWindowSP(QWidget *parent) : SettingsWindow(parent) {
  ...
  QList<PanelInfo> panels = {
    PanelInfo("   " + tr("Device"), device, "../../chubbs/selfdrive/assets/offroad/icon_home.svg"),
    PanelInfo("   " + tr("Network"), networking, "../assets/offroad/icon_network.png"),
    PanelInfo("   " + tr("The Pond"), new SunnylinkPanel(this), "../assets/offroad/icon_wifi_strength_full.svg"),
    PanelInfo("   " + tr("Toggles"), toggles, "../../chubbs/selfdrive/assets/offroad/icon_toggle.png"),
    PanelInfo("   " + tr("Software"), new SoftwarePanelSP(this), "../../chubbs/selfdrive/assets/offroad/icon_software.png"),
    PanelInfo("   " + tr("Chubbs"), new ChubbsPanel(this), "../assets/images/button_home.png"),
    PanelInfo("   " + tr("Trips"), new TripsPanel(this), "../../chubbs/selfdrive/assets/offroad/icon_trips.png"),
    PanelInfo("   " + tr("Vehicle"), new VehiclePanel(this), "../../chubbs/selfdrive/assets/offroad/icon_vehicle.png"),
  ...
  for (auto &[name, panel, icon] : panels) {
    ...
    const int lr_margin = (name != ("   " + tr("Network")) || (name != ("   " + tr("chubbs")))) ? 50 : 0;  // Network and chubbs panel handles its own margins
