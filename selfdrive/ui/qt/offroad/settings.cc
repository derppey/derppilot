...
TogglesPanel::TogglesPanel(SettingsWindow *parent) : ListWidget(parent) {
  ...
  accel_personality_setting = new ButtonParamControlSP("AccelPersonality", tr("Acceleration Personality"),
                                          tr("Normal is recommended. In sport mode, chubbs will provide aggressive acceleration for a dynamic driving experience. "
                                             "In eco mode, chubbs will apply smoother and more relaxed acceleration. On supported cars, you can cycle through these "
