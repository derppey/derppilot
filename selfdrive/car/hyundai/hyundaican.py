...
def create_acc_commands(packer, enabled, accel, jerk, idx, hud_control, set_speed,
                        stopping, long_override, use_fca, CS, CP,
                        cruise_available):
  ...
  scc14_values = {
    ...
    "JerkUpperLimit": jerk.jerk_upper_limit, # stock usually is 1.0 but sometimes uses higher values
    "JerkLowerLimit": jerk.jerk_lower_limit, # stock usually is 0.5 but sometimes uses higher values
