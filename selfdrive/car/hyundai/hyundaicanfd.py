...
def create_acc_control(packer, CAN, CS, enabled, accel_last, accel, jerk, stopping, gas_override, set_speed, hud_control):
  #jerk = 5
  jerk_upper = jerk.jerk_upper_limit
  jerk_lower = jerk.jerk_lower_limit
  jn = jerk_upper / 50
