...
std::unordered_map<std::string, uint32_t> keys = {
    ...
    {"OnroadMode", CLEAR_ON_MANAGER_START},
    ...
    {"DECLead", PERSISTENT},
    {"DECModelStopTime", PERSISTENT},
    {"DECNavigation", PERSISTENT},
    {"DECNavigationIntersections", PERSISTENT},
    {"DECNavigationLead", PERSISTENT},
    {"DECNavigationTurns", PERSISTENT},
    {"DECSignalSpeed", PERSISTENT},
    {"DECSignalLaneDetection", PERSISTENT},
    {"DECSlowerLead", PERSISTENT},
    {"DECSpeed", PERSISTENT},
    {"DECSpeedLead", PERSISTENT},
    {"DECStatus", CLEAR_ON_OFFROAD_TRANSITION},
    {"DECStoppedLead", PERSISTENT},
    {"ShowDECStatus", PERSISTENT},
};
